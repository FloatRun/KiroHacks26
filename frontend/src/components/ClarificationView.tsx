...
export default function ClarificationView({
  ...
  return (
    <main className="flex flex-col gap-5 px-4 py-6" aria-labelledby="clarification-heading">
      ...
      {/* Answer input */}
      <div>
        <label htmlFor="clarification-input" className="mb-1.5 block text-sm font-semibold text-gray-700">
          Your answer
        </label>

        {/* Textarea with mic inset bottom-right — same pattern as QueryInput */}
